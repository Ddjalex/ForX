document.addEventListener('DOMContentLoaded', function() {
    ...
    loadStockMarketData();
    setInterval(loadCryptoMarketData, 30000);
    setInterval(loadStockMarketData, 30000);
});
...
const stockData = [
    { symbol: 'NASDAQ', name: 'NASDAQ', value: '97.46⬇️', change: '2.10', changePercent: '2.20%', open: '95.36', high: '97.72', low: '9' },
    { symbol: 'AAPL', name: 'APPLE STOCK', value: '270.97⬇️', change: '-2.70', changePercent: '-0.99%', open: '272.86', high: '273.88', low: '27' },
    { symbol: 'GOOGL', name: 'GOOGL', value: '309.78⬆️', change: '2.62', changePercent: '0.89%', open: '309.88', high: '310.13', low: '30' },
    { symbol: 'NVAX', name: 'NVAX NA', value: '6.89⬇️', change: '0.23', changePercent: '3.45%', open: '6.71', high: '6.98', low: 'N/A' },
    { symbol: 'AMZN', name: 'AMAZON', value: '228.43⬆️', change: '1.08', changePercent: '0.48%', open: '228.61', high: '229.48', low: '22' },
    { symbol: 'FACEB', name: 'FACEBOOK', value: 'N/A', change: 'N/A', changePercent: 'N/A', open: 'N/A', high: 'N/A', low: 'N/A' },
    { symbol: 'TSLA', name: 'TESLA', value: '1.54⬆️', change: '0.02', changePercent: '1.32%', open: '1.54', high: '1.60', low: 'N/A' }
];
...
function loadCryptoMarketData() {
    ...
    cryptoData.forEach(crypto => {
        html += `
            <tr onclick="navigateToTrade('${crypto.symbol}')">
                <td class="market-symbol">
                    <span style="display: flex; align-items: center; gap: 8px;">
                        <span style="width: 24px; height: 24px; background: var(--primary); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 10px; font-weight: bold; color: var(--bg-dark);">${crypto.symbol.charAt(0)}</span>
...
function loadStockMarketData() {
    ...
    stockData.forEach(stock => {
        ...
        html += `
            <tr onclick="navigateToTrade('${stock.symbol}')">
                <td class="market-symbol">
                    <span style="display: flex; align-items: center; gap: 8px;">
                        <span style="width: 24px; height: 24px; background: var(--primary); border-radius: 4px; display: flex; align-items: center; justify-content: center; font-size: 10px; font-weight: bold; color: var(--bg-dark);">◆</span>
