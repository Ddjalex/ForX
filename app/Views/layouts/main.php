...
<body>
            ...
            <div class="sidebar-user">
                <div class="sidebar-user-avatar">
                    ...
                    <div class="sidebar-user-info">
                        <span class="sidebar-user-name" style="display: block; font-weight: 600;"><?= htmlspecialchars($user['name'] ?? 'User') ?></span>
                        <span class="sidebar-user-status" style="font-size: 11px; opacity: 0.8;"><?= ($user['kyc_status'] ?? 'pending') === 'approved' ? t('verified') : t('not_verified') ?></span>
                    </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Language selector logic if needed
        });
    </script>
    <!-- tawk.to -->
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/69440144c73adf1980aab71c/default';
    s1.charset='UTF-8';
