...
<body>
    ...
    $tawkPropertyResult = \App\Core\Database::fetch("SELECT value FROM settings WHERE key = ?", ['tawkto_property_id']);
    $tawkWidgetResult = \App\Core\Database::fetch("SELECT value FROM settings WHERE key = ?", ['tawkto_widget_id']);
