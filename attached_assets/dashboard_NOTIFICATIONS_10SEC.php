...
<div class="trading-section">
    ...
    <div class="card live-trading-card">
        ...
        <div class="card-body" id="tradingCard">
            <form method="POST" action="/dashboard/trades/history" id="tradeForm" class="trading-form">
                ...
                <div class="form-group">
                    ...
                    <div class="leverage-slider-container">
                        <input type="range" id="leverageSlider" class="leverage-slider" min="1" max="100" value="5" oninput="setLeverageFromSlider(this.value)">
